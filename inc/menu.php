...
function trailhead_top_nav() {
	wp_nav_menu(array(
		...
		'items_wrap'		=> '<ul id="%1$s" class="%2$s" data-responsive-menu="accordion tablet-dropdown" data-submenu-toggle="true" data-hover-delay="200" data-closing-time="200" data-smooth-scroll data-animation-easing="swing">%3$s</ul>',
...
function trailhead_off_canvas_nav() {
	wp_nav_menu(array(
		...
		'items_wrap'		=> '<ul id="%1$s" class="%2$s" data-accordion-menu data-smooth-scroll data-animation-easing="swing">%3$s</ul>',
...
function trailhead_footer_links() {
	wp_nav_menu(array(
		...
		'items_wrap'		=> '<ul id="%1$s" class="%2$s" data-smooth-scroll data-animation-easing="swing">%3$s</ul>',
